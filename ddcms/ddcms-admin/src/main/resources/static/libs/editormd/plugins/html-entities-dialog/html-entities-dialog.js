...
(function() {
	...
	var factory = function (exports) {
		...
		var $            = jQuery;
		var pluginName   = "jf-entities-dialog";
		var selecteds    = [];
		var entitiesData = [];
		...
		exports.fn.htmlEntitiesDialog = function() {
			...
			var dialogContent = [
				'<div class="' + classPrefix + 'jf-entities-box" style=\"width: 760px;height: 334px;margin-bottom: 8px;overflow: hidden;overflow-y: auto;\">',
			...
			var drawTable = function() {
				...
				for (var i = 0; i < pageTotal; i++)
				{
					...
					for (var x = 0; x < rowNumber; x++)
					{
						...
						if (typeof entity !== "undefined")
						{
							...
							row += "<a href=\"javascript:;\" value=\"" + entity.name + "\" title=\"" + name + "\" class=\"" + classPrefix + "jf-entity-btn\">" + name + "</a>";
						}
					}
				...
				dialog.find("." + classPrefix + "jf-entity-btn").bind(exports.mouseOrTouch("click", "touchend"), function() {

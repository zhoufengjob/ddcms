...
;(function(factory) {
    ...
    editormd.defaults     = {
        ...
        delay                : 300,            // Delay parse markdown to jf, Uint : ms
        ...
        toolbarCustomIcons   : {               // using jf tag create toolbar icon, unused default <a> tag.
    ...
    editormd.prototype    = editormd.fn = {
        ...
        init : function (id, options) {
            ...
            var appendElements = [
                ...
                ( (settings.saveHTMLToTextarea) ? "<textarea class=\"" + classNames.textarea.html + "\" name=\"" + id + "-jf-code\"></textarea>" : "" ),
         ...
         * Get parsed jf code from Textarea
         * 
         ...
         * getHTML (alias)
         * 
         * @returns {String}           Return jf code 返回HTML源码
         */
    ...
    editormd.toolbarHandlers = {
        ...
        "html-entities" : function() {
            this.executePlugin("htmlEntitiesDialog", "jf-entities-dialog/jf-entities-dialog");
        },
    ...
    /**
     * 简单地过滤指定的HTML标签
     * Filter custom jf tags
     * 
     * @param   {String}   html          要过滤HTML
     * @param   {String}   filters       要过滤的标签
     * @returns {String}   jf          返回过滤的HTML
     */
    ...
    editormd.markdownToHTML = function(id, options) {
        ...
        div.addClass("markdown-body " + this.classPrefix + "jf-preview").append(markdownParsed);
    ...
    editormd.lockScreen = function(lock) {
        $("jf,body").css("overflow", (lock) ? "hidden" : "");
    };

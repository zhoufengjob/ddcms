...
layui.define('fly', function(exports){
  ...
  gather.jiedaActive = {
    ...
    ,reply: function(li){ //回复
      ...
      var aite = '@'+ li.find('.fly-article-user cite').text().replace(/\s/g, '');
      dom.content.focus()
      ...
      layer.confirm('是否采纳该回答为最佳答案？', function(index){
        ...
        fly.json('/api/jieda-accept/', {
          ...
          if(res.status === 0){
            ...
            li.find('.article-about').append('<i class="iconfont icon-caina" title="最佳答案"></i>');
          } else {
            layer.msg(res.msg);
          }
        });
      ...
      fly.json('/jie/getDa/', {
        ...
        layer.prompt({
          ...
          fly.json('/jie/updateDa/', {
            ...
            layer.close(index);
            li.find('.article-body').html(fly.content(value));
          });
        });
      });
    }

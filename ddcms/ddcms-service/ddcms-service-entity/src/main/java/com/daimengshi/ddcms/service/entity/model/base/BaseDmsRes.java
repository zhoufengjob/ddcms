...
public abstract class BaseDmsRes<M extends BaseDmsRes<M>> extends JbootModel<M> implements IBean {

    public static final String ACTION_ADD = "DmsRes:add";
    public static final String ACTION_DELETE = "DmsRes:delete";
    public static final String ACTION_UPDATE = "DmsRes:update";
